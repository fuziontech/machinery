...
import (
	...
	amqpbroker "github.com/fuziontech/machinery/v1/brokers/amqp"
	eagerbroker "github.com/fuziontech/machinery/v1/brokers/eager"
	gcppubsubbroker "github.com/fuziontech/machinery/v1/brokers/gcppubsub"
	brokeriface "github.com/fuziontech/machinery/v1/brokers/iface"
	redisbroker "github.com/fuziontech/machinery/v1/brokers/redis"
	sqsbroker "github.com/fuziontech/machinery/v1/brokers/sqs"

	amqpbackend "github.com/fuziontech/machinery/v1/backends/amqp"
	dynamobackend "github.com/fuziontech/machinery/v1/backends/dynamodb"
	eagerbackend "github.com/fuziontech/machinery/v1/backends/eager"
	backendiface "github.com/fuziontech/machinery/v1/backends/iface"
	memcachebackend "github.com/fuziontech/machinery/v1/backends/memcache"
	mongobackend "github.com/fuziontech/machinery/v1/backends/mongo"
	nullbackend "github.com/fuziontech/machinery/v1/backends/null"
	redisbackend "github.com/fuziontech/machinery/v1/backends/redis"

	eagerlock "github.com/fuziontech/machinery/v1/locks/eager"
	lockiface "github.com/fuziontech/machinery/v1/locks/iface"
	redislock "github.com/fuziontech/machinery/v1/locks/redis"
)
